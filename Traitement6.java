...
public class Traitement6 {

    public static void main(String[] args) {
        try {
            File file = new File("C:\\Users\\Oumayma Aoun\\Desktop\\SOC\\route2023.xml");
            ...
            for (Map.Entry<String, Map<String, Integer>> entry : accidentsByRoadType.entrySet()) {
